  	...
  	extend: {
        ...
        'cyber-accent': '#58a6ff',
  		...
  		boxShadow: {
  			...
  			'glow-lg': '0 0 40px -10px rgba(88, 166, 255, 0.3)',
  		...
  		keyframes: {
  			...
  			glow: {
  				'0%, 100%': {
  					boxShadow: '0 0 20px -5px rgba(88, 166, 255, 0.4)'
  				},
  				'50%': {
  					boxShadow: '0 0 40px -5px rgba(88, 166, 255, 0.6)'
  				}
  			},
  			float: {
  				'0%, 100%': {
  		...
  		backgroundImage: {
  			...
  			'gradient-primary': 'linear-gradient(135deg, #58a6ff, #764ba2)',
